...
if "ARCHIVE_URL" in env:  # TODO: Remove after migration - Add "ARCHIVE_URL" to env
    DATABASES.update({"archive": env.db("ARCHIVE_URL")})
...
ADMINS = [tuple(admin.strip().rsplit(" ", 1)) for admin in env("ADMINS", default="").split(",") if admin]
...
ACCOUNT_FORMS = {"signup": "events.users.forms.UserSignupForm", "login": "events.users.forms.UserLoginForm"}
# https://django-allauth.readthedocs.io/en/latest/configuration.html
