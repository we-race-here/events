...
class Command(BaseCommand):
    ...
    def migrate_cycling_org_organizations(self):
        ...
        for src_org in source_orgs:
            ...
            dest_org.description = (
                json.loads(src_org.prefs.information_board_content) if src_org.prefs.information_board_content else None
            )
            ...
            # TODO: migrate hero (banner_image) from prefs
            dest_org.hero = json.loads(src_org.prefs.banner_image)
